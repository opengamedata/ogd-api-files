    ...
    class GameDatasetInfo(Resource):
        ...
        # 2. Search for the most recently modified dataset that contains the requested month and year
            ...
            if _matched_dataset.Key.DateFrom and _matched_dataset.Key.DateTo:
                ...
                file_info["detectors_link"] = f"{GITHUB_BASE_URL}{_revision}/src/ogd/games/{sanitized_request.GameID}/detectors" if _revision else None
                file_info["features_link"]  = f"{GITHUB_BASE_URL}{_revision}/src/ogd/games/{sanitized_request.GameID}/features"  if _revision else None
